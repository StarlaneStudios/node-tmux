...
var Tmux = /** @class */ (function () {
     ...
     */
    Tmux.prototype.createSession = function (name, command) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.sessionExits(name))
                            throw new Error("Session already exists");
                        return [4 /*yield*/, this._exec("tmux new -s " + name + (command ? " " + command : ''))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    Tmux.prototype.getSessions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var out;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._exec("tmux ls -F \"#S\"")];
                    case 1:
                        out = _a.sent();
     ...
     */
    Tmux.prototype.sessionExits = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSessions()];
                    case 1:
                        list = _a.sent();
                        return [2 /*return*/, list.indexOf(name) != -1];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._exec("tmux kill-session -s " + name)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Tmux.prototype.writeInput = function (name, print, newline) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._exec("tmux send-keys -s " + name + " \"" + print + "\"" + (newline ? ' Enter' : ''))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    Tmux.prototype._exec = function (command) {
        var _this = this;
        return new Promise(function (success, reject) {
            child_process_1.exec(command, _this.options, function (err, stdout, stderr) {
                if (err) {
                    reject(err);
                }
                else {
...
function tmux(options) {
    ...
    return new Promise(function (success) {
        var process = child_process_1.exec('tmux ls', options);
