    ...
    Tmux.prototype.newSession = function (name, command) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.hasSession(name)];
                    case 1:
                        if (_a.sent()) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._exec(this.options.command + " has-session -s " + name)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._exec(this.options.command + " rename-session -s " + name + " " + newName)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
