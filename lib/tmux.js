...
var Tmux = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ext = command ? " " + command : '';
                        return [4 /*yield*/, this._exec(this.options.command + " new -s " + name + ext)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Tmux.prototype.getSessions = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._exec(this.options.command + " ls -F \"#S\"")];
                    case 1:
                        out = _a.sent();
     ...
     */
    Tmux.prototype.isSession = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._exec(this.options.command + " kill-session -s " + name)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ext = newline ? ' Enter' : '';
                        return [4 /*yield*/, this._exec(this.options.command + " send-keys -s " + name + " \"" + print + "\"" + ext)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
function tmux(options) {
    ...
    return new Promise(function (success, reject) {
        var process = child_process_1.exec((options.command || "tmux") + " ls", {
            shell: options.shell
        });
